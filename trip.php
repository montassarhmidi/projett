...
<h1>Accessorie Informatique<br><br></h1>
...
<table class="table table-hover table-fixed">
  ...
  <tbody>
   ...
   $trii=$PublicC->tripublicite('Accessorie Informatique');
...
<h1>Materiel Informatique<br><br></h1>
...
<table class="table table-hover table-fixed">
  ...
  <tbody>
   ...
   $trii=$PublicC->tripublicite('Materiel Informatique');
...
<table class="table table-hover table-fixed">
  ...
  <tbody>
   ...
   $trii=$PublicC->tripublicite('Materiel Sucurite');
