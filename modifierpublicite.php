<?PHP
include "../entities/pulicite.php";
include "../core/publiciteC.php";
if (isset($_GET['id'])){
  $publiciteC=new publiciteC();
    $result=$publiciteC->recupererpublite($_GET['id']);
  foreach($result as $row){
    $id=$row['id'];
     $type=$row['type'];
    $nom=$row['nom'];
    $description=$row['description'];
    $prix_sans_remise=$row['prix_sans_remise'];
  $prix_avec_remise=$row['prix_avec_remise'];
        $fichier=$row['fichier'];
...
if (isset($_POST['modifier'])){
    $publicite=new publicite($_POST['id'],$_POST['type'],$_POST['nom'],$_POST['description'],$_POST['prix_sans_remise'],,$_POST['prix_avec_remise'],$_POST['fichier']);
    $publiciteC->modifierpublicite($publicite,$_GET['id']);
    echo $_GET['id'];
...
<body>
 ...
 <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="id" class="form-control" placeholder="id" type="text"value="<?PHP echo $id ?>"/>
            </div>
          </div>
...
<select name="type" class="form-control">
 ...
 <option value="Materiel Sucurite">Materiel Sucurite</option> 
          ...
          <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="nom" class="form-control" placeholder="nom" type="text"value="<?PHP echo $nom ?>"/>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="prix_sans_remise" class="form-control" placeholder="prix_sans_remise" type="text"value="<?PHP echo $prix_sans_remise ?>"/>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="prix_avec_remise" class="form-control" placeholder="prix_avec_remise" type="text"value="<?PHP echo $prix_avec_remise ?>"/>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="email">fichier</label>
              <input  type="file"name="fichier" class="form-control" placeholder="fichier" type="text"value="<?PHP echo $fichier ?>"/>
            </div>
          </div>
