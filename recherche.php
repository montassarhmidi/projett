<?PHP
//include "../config.php";
require  "../core/relationclientC.php";
$RelationclientC=new RelationclientC();
if(!(isset($_GET['recherche']))){
$listeEmploye=$RelationclientC->afficherRelationclient();
$listeEmploye1=$RelationclientC->afficherRelationclient();
}
else{
	
	$listeEmploye=$RelationclientC->rechercheRelationclient($_GET['recherche']);
	$listeEmploye1=$RelationclientC->afficherRelationclient();
