...
{
$Relationclient1C=new Relationclient(($_POST['Nom']),($_POST['Prenom']),'Normal',($_POST['Email']),($_POST['Adresse']),($_POST['Gouvernorat']),($_POST['Ville']),($_POST['CodePostal']) ,($_POST['Telephone']) ,($_POST['Password']));
var_dump($Relationclient1C);
$RelationclientC=new RelationclientC();
$RelationclientC->ajouterRelationclient($Relationclient1C);
header('Location: ../fidelite.html');
	}
